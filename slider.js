        ...
        render() {
               ...
               return ( 
                        <div id="volume-slider">
                               <svg id="volume-icon" className="volume-icon"  viewBox="-1 0 33 32">
                                     <defs>
                               ...
                               <div className="volume-track"  onClick={this.props.handleVolume}>
                                 <span id="volume-indicator" className="volume-indicator"></span>
                                 <input type="hidden" name="volume" id="volume-input" value={this.props.volume} onChange={this.props.handleVolume}/>
                               </div>
                     </div>
             )
        }
